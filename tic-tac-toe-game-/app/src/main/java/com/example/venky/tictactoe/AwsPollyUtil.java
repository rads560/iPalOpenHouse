...
public class AwsPollyUtil {
    ...
    private static final String KEY_SAMPLE_TEXT = "Ohh! yeah!";//"<speak><prosody volume=\"x-loud\" rate=”slow”> Ohh Yeaah! </prosody></speak>";
    ...
    public void playMusic() {
        ...
        String text = "<speak>\n" +
                "<prosody volume=\"x-loud\"><prosody rate=\"x-slow\">noo!</prosody>\n" +
                "</prosody>" +
                "\n</speak>";


        Date date = new Date();
        date.setYear(date.getDate()+6);
        ...
        synthesizeSpeechPresignRequest.setExpiration(date);
